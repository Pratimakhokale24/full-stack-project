...
import { draftInterviewEmail } from '../frontend/src/services/geminiService';
...
const InterviewStep: React.FC<InterviewStepProps> = ({ candidates, jobDetails, onRestart, onBack }) => {
